...
RSpec.describe "Api::V1::EmergencyContacts", type: :request do
  ...
  describe "POST /create" do
    it "creates valid emergency contact" do
      ...
      post "/api/v1/emergency-contacts/create", params: { emergency_contact: valid_emergency_contact }, headers: set_headers(user)
    ...
    it "rejects emergency contact creation with invalid emergency contact" do
      login_and_confirm(user)
      post "/api/v1/emergency-contacts/create", params: { emergency_contact: invalid_emergency_contact }, headers: set_headers(user)
  ...
  #     login_and_confirm(user)
  #     patch "/api/v1/emergency-contacts/update/#{emergency_contact.uid}", params: { emergency_contact: valid_emergency_contact }, headers: set_headers(user)
  ...
  #     login_and_confirm(user)
  #     patch "/api/v1/emergency-contacts/update/#{emergency_contact.uid}", params: { emergency_contact: invalid_emergency_contact }, headers: set_headers(user)
  #     expect(json_response["errors"].size).to be > 0
  #     expect(response).to have_http_status(:unprocessable_entity)
  #   end
  # end
  ...
  #     login_and_confirm(user)
  #     delete "/api/v1/emergency-contacts/destroy/#{emergency_contact.uid}", headers: set_headers(user)
