...
RSpec.describe "Api::V1::Abstracts", type: :request do
  ...
  describe "POST /create" do
    it "creates abstract with valid abstract" do
      ...
      post "/api/v1/abstracts/create/#{admission.uid}", params: { abstract: valid_create }, headers: set_headers
    ...
    it "rejects abstract creation with invalid abstract" do
      login_and_confirm(user)
      post "/api/v1/abstracts/create/#{admission.uid}", params: { abstract: invalid_create_update }, headers: set_headers
  ...
  describe "PATCH /update" do
    it "updates abstract with valid abstract" do
      login_and_confirm(user)
      patch "/api/v1/abstracts/update/#{admission.uid}", params: { abstract: valid_update }, headers: set_headers
    ...
    it "rejects abstract update with invalid abstract" do
      login_and_confirm(user)
      patch "/api/v1/abstracts/update/#{admission.uid}", params: { abstract: invalid_create_update }, headers: set_headers
