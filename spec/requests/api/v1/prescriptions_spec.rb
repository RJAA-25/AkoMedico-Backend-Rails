...
RSpec.describe "Api::V1::Prescriptions", type: :request do
  ...
  #     post "/api/v1/prescriptions/create/#{consultation.uid}", params: { prescription: valid_create }, headers: set_headers(user)
  ...
  #     login_and_confirm(user)
  #     post "/api/v1/prescriptions/create/#{consultation.uid}", params: { prescription: invalid_create_update }, headers: set_headers(user)
  ...
  #     login_and_confirm(user)
  #     patch "/api/v1/prescriptions/update/#{consultation.uid}", params: { prescription: valid_update }, headers: set_headers(user)
  ...
  #     login_and_confirm(user)
  #     patch "/api/v1/prescriptions/update/#{consultation.uid}", params: { prescription: invalid_create_update }, headers: set_headers(user)
